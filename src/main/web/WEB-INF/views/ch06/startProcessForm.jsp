    ...
    <script type="text/javascript">
        $(function () {
            ...
            $('#userModal').on('show', function () {
                ...
                $.getJSON('/user/list', function (datas) {
...
<div id="userModal" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="userModalLabel"
     aria-hidden="true" style="width: 260px;">
