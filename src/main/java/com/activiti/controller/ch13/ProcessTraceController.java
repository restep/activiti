...
import com.activiti.util.ActivityUtil;
...
public class ProcessTraceController extends AbstractController {
    /**
     * 读取流程资源
     */
    ...
    public ModelAndView historyDatas(@PathVariable("executionId") String executionId) {
        ModelAndView mav = new ModelAndView("ch13/processTrace");
